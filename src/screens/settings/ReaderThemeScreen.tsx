...
const ColourRow: React.FC<ColourRowProps> = ({
  label,
  value,
  swatches,
  onChange,
          ...
          >
            {sw === value && (
              <Ionicons
                name="checkmark"
                size={12}
                color={sw === "#FFFFFF" || sw === "#F5EDD6" ? "#333" : "#FFF"}
              />
            )}
          </TouchableOpacity>
        ))}
...
export const ReaderThemeScreen: React.FC = () => {
  ...
  const applyPreset = useCallback(
    async (key: string, bg: string, fg: string) => {
      ...
      >
        ...
        <View style={S.previewSection}>
          ...
          >
            ...
            <Text
              ...
              numberOfLines={3}
            >
              The sun had long since set behind the mountains, casting long
              violet shadows across the silent valley below.
            </Text>
          </View>
        </View>
          ...
          <View style={S.presetGrid}>
            {PRESETS.map((p) => {
              ...
              return (
                ...
                >
                  <Text style={[S.presetCardLabel, { color: p.fg }]}>
                    {p.label}
                  </Text>
        ...
        >
          <ColourRow
            ...
            onChange={(v) =>
              void updateReaderSettings("theme", "backgroundColor", v)
            }
          />
          <View
            style={[S.divider, { backgroundColor: theme.colors.divider }]}
          />
          <ColourRow
            label="Text"
            value={t.textColor}
